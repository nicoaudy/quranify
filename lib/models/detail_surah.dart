...
List<Map<String, DetailSurah>> detailSurahFromJson(String str) =>
    List<Map<String, DetailSurah>>.from(json.decode(str).map((x) => Map.from(x)
        .map((k, v) =>
            MapEntry<String, DetailSurah>(k, DetailSurah.fromJson(v)))));

String detailSurahToJson(List<Map<String, DetailSurah>> data) =>
